...
// the type of tx data (e.g.: standard
// bytes or data bytes).
type FeeType string
...
// AddMiner will add a new miner to the quote map with the provided feeQuote.
...
//	fq := NewFeeQuote()
//
// The fees have an expiry time which, when initially setup, has
...
// AddQuote will add a new set of quotes for a feetype or update an existing
